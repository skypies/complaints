...
function captureAreaOverlay() {
    var rectangle = new google.maps.Rectangle({
        ...
        bounds: new google.maps.LatLngBounds(
            new google.maps.LatLng({{.CaptureArea.SW.Lat}}, {{.CaptureArea.SW.Long}}),
            new google.maps.LatLng({{.CaptureArea.NE.Lat}}, {{.CaptureArea.NE.Long}})),
    });
}
...
/* This is the rarely used 'bad weather' fork (uses the other runway ?)
