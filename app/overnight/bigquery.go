...
func publishComplaintsAllHandler(w http.ResponseWriter, r *http.Request) {
	ctx := req2ctx(r)
	str := ""
...
func publishComplaintsDayHandler(w http.ResponseWriter, r *http.Request) {
	tStart := time.Now()
